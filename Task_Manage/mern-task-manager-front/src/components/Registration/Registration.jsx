...
const Registration = () => {
    ...
    const onRegistration = () => {
        ...
        if(IsEmail(email)) ErrorToast("Valid Email Address Required!")
        else if(IsEmpty(firstName)) ErrorToast("First Name Required!")
        else if (IsEmpty(lastName)) ErrorToast("Last Name Required!")
        else if (!IsMobile(mobile)) ErrorToast("Valid Mobile Required!")
        else if (IsEmpty(password)) ErrorToast("Password Required!")
        else {
            RegistrationRequest(email,firstName,lastName,mobile,password,"").then(res=>{
                if (res===true){
                    navigate('/login')
                }
            })
        ...
        console.log(email+fastName+lastName+mobile+password)

...
import {GetProfileDetails, ProfileUpdateRequest, TaskListByStatus} from "../../APIRequest/APIRequest";
                                ...
                                <div className="container-fluid">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-4 p-2">
                                            ...
                                            <input  key={Date.now()} defaultValue={ProfileData['first_name']} ref={(input)=>firstNameRef=input} placeholder="First Name" className="form-control animated fadeInUp" type="text"/>
                                        </div>
                                        <div className="col-4 p-2">
                                            <label>Last Name</label>
                                            <input key={Date.now()} defaultValue={ProfileData['last_name']}  ref={(input)=>lastNameRef=input} placeholder="Last Name" className="form-control animated fadeInUp" type="text"/>
                                        </div>
                                        <div className="col-4 p-2">
                                            <label>Mobile</label>
